...
export class RequestDedupeManager {
   ...
   * @param cacheKey - Unique identifier for the request used for deduplication (generated by JinFrame._getCacheKey())
   ...
   * @example
   * ```ts
   * // Cache key is typically generated by JinFrame._getCacheKey()
   * const frame = GetUserFrame.of({ id: '123' });
   * const cacheKey = frame._getCacheKey();
   *
